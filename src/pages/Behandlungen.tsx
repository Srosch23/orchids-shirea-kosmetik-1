...
const treatmentData: Record<string, {
  ...
  "byonik-lift-fresh-up": {
    title: "BYONIK® Lift Fresh-Up",
    subtitle: "Schnelle Erfrischung mit Laser",
    duration: "30 Min.",
    price: "79 €",
    description: "Die perfekte Behandlung für zwischendurch: Das BYONIK® Lift Fresh-Up ist Ihre Express-Lösung für sofortige Frische und Strahlkraft. In nur 30 Minuten schenken wir Ihrer Haut einen sichtbaren Boost – ideal vor wichtigen Terminen, Events oder einfach, um sich selbst etwas Gutes zu tun.",
    process: [
  ...
  "byonik-gesicht-hals-dekollete": {
    title: "BYONIK® Gesicht, Hals & Dekolleté",
