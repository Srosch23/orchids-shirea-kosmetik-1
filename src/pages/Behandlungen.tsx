...
const treatmentData: Record<string, {
  ...
  "klassische-gesichtsbehandlung": {
    ...
    "byonik-anti-aging": {
      title: "BYONIK® Lift PTL Facial | Gesicht",
      subtitle: "Innovative pulsgesteuerte Laserbehandlung",
      ...
      process: [
        ...
        "Pulsgesteuerte Laserbehandlung des Gesichts",
  ...
  "slimyonik": {
    ...
    faq: [
      ...
      { question: "Welche Behandlungspakete bieten Sie an?", answer: "Einzelbehandlung: 59 € – perfekt zum Kennenlernen. Basic-Kur (10 Behandlungen): 499 € statt 590 € inkl. Behandlungsgutschein für Familie und Freunde – ideal für sichtbare Ergebnisse. Professional-Kur (12 Behandlungen): 599 € statt 708 € inkl. Behandlungsgutschein und kostenlosem Produkt – maximale Wirkung für langfristige Erfolge." },
  ...
  "augenbrauenlifting": {
    ...
    "wimpern-farben": {
      ...
      subtitle: "Intensivere Wimpern ohne Mascara",
      description: "Verleihen Sie Ihren Wimpern mehr Ausdruckskraft mit einer professionellen Wimpernfärbung. Die sanfte Färbung betont Ihre natürlichen Wimpern, sodass sie dunkler und voller wirken – ganz ohne tägliches Mascara-Styling. Perfekt für helle Wimpern oder für den natürlichen Look im Alltag.",
      process: [
        "Beratung zur gewünschten Farbintensität",
        "Reinigung der Wimpern und Augenpartie",
        "Schutz der Haut mit speziellen Pads",
        "Auftragen der Wimpernfarbe",
        "Einwirkzeit für optimale Farbentwicklung",
        "Gründliche Entfernung der Farbe",
        "Pflegende Abschlussbehandlung",
      ],
      benefits: [
        "Intensivere, dunklere Wimpern",
        "Kein tägliches Mascara-Auftragen nötig",
        "Natürlich wirkende Betonung der Augen",
        "Wasserfest und langanhaltend",
        "Ideal für Sport, Strand und Pool",
        "Hält 3-4 Wochen",
        "Zeitsparend im Alltag",
      ],
      faq: [
        { question: "Wie lange hält die Wimpernfärbung?", answer: "Die Färbung hält etwa 3-4 Wochen, abhängig vom Wimpernwachstum." },
        { question: "Ist die Färbung schädlich für die Wimpern?", answer: "Nein, wir verwenden professionelle, hautverträgliche Farben, die speziell für die empfindliche Augenpartie entwickelt wurden." },
        { question: "Welche Farben sind möglich?", answer: "Wir bieten verschiedene Farbnuancen von Schwarz über Braun bis hin zu Blauschwarz – passend zu Ihrem Typ." },
      ],
    },
    "augenbrauen-formen": {
      title: "Augenbrauen formen",
      subtitle: "Perfekte Brauenform für Ihren Typ",
      description: "Gut geformte Augenbrauen verleihen Ihrem Gesicht Struktur und Ausdruck. Mit präziser Pinzettentechnik und professionellem Augenmaß formen wir Ihre Brauen passend zu Ihrer Gesichtsform. Das Ergebnis: harmonische, natürlich wirkende Brauen, die Ihre natürliche Schönheit unterstreichen.",
      process: [
        "Beratung zur idealen Brauenform für Ihr Gesicht",
        "Reinigung und Vorbereitung der Augenbrauen",
        "Präzises Zupfen für die perfekte Form",
        "Nachzeichnen und Korrektur",
        "Beruhigende Pflege",
        "Styling-Tipps für zu Hause",
      ],
      benefits: [
        "Perfekt geformte, symmetrische Brauen",
        "Betonung Ihrer natürlichen Gesichtszüge",
        "Professionelle, präzise Arbeit",
        "Sofort gepflegtes Erscheinungsbild",
        "Langanhaltend schöne Form",
        "Individuelle Beratung",
        "Offener, ausdrucksstarker Blick",
      ],
      faq: [
        { question: "Ist das Zupfen schmerzhaft?", answer: "Die meisten Kunden empfinden es als gut erträglich. Wir arbeiten präzise und schnell, um Unannehmlichkeiten zu minimieren." },
        { question: "Wie oft sollte ich meine Brauen formen lassen?", answer: "Für eine perfekte Form empfehlen wir alle 3-4 Wochen eine professionelle Formung." },
        { question: "Kann ich danach Make-up auftragen?", answer: "Wir empfehlen, 2-3 Stunden auf Augenbrauen-Make-up zu verzichten, damit die Haut sich beruhigen kann." },
      ],
    },
    "augenbrauen-farben": {
      title: "Augenbrauen färben",
      subtitle: "Definierte Brauen mit mehr Intensität",
      description: "Schenken Sie Ihren Augenbrauen mehr Ausdruckskraft mit einer professionellen Brauenfärbung. Die sanfte Färbung betont Ihre natürliche Brauenform und verleiht ihr mehr Fülle und Definition – ideal für helle oder spärliche Brauen. Wachen Sie jeden Morgen mit perfekt definierten Brauen auf.",
      process: [
        "Beratung zur passenden Farbauswahl",
        "Reinigung der Augenbrauenpartie",
        "Schutz der Haut",
        "Präzises Auftragen der Brauenfarbe",
        "Einwirkzeit für optimale Farbentwicklung",
        "Gründliche Entfernung der Farbe",
        "Pflegende Abschlusspflege",
      ],
      benefits: [
        "Definierte, intensivere Augenbrauen",
        "Optisch vollere Brauen",
        "Kein tägliches Nachzeichnen nötig",
      ...
      faq: [
        { question: "Wie lange hält die Brauenfärbung?", answer: "Die Färbung hält etwa 3-4 Wochen, abhängig vom Haarwachstum." },
        { question: "Welche Farben stehen zur Auswahl?", answer: "Wir bieten verschiedene Brauntöne sowie Schwarz und Grau – passend zu Ihrer natürlichen Haarfarbe." },
        { question: "Kann ich die Färbung mit anderen Behandlungen kombinieren?", answer: "Ja, perfekt in Kombination mit Augenbrauen formen oder als Teil unseres Komplett-Pakets." },
      ],
    },
    "augenbrauen-formen-farben": {
      title: "Augenbrauen formen & färben",
      subtitle: "Rundum-Pflege für perfekte Brauen",
      description: "Die ideale Kombination für makellos gepflegte Augenbrauen. Wir formen Ihre Brauen passend zu Ihrer Gesichtsform und färben sie anschließend für mehr Definition und Intensität. Das perfekte Duo für einen ausdrucksstarken, natürlich schönen Blick.",
      process: [
        "Beratung zu Form und Farbe",
        "Reinigung und Vorbereitung",
        "Präzises Formen der Augenbrauen",
        "Auftragen der passenden Brauenfarbe",
        "Einwirkzeit für optimale Farbentwicklung",
        "Entfernung der Farbe",
        "Pflegende Abschlusspflege",
      ],
      benefits: [
        "Perfekt geformte und gefärbte Brauen in einer Behandlung",
        "Zeit- und kostenersparend",
        "Harmonisches Gesamtergebnis",
        "Ausdrucksstarker Blick",
        "Kein tägliches Styling nötig",
        "Langanhaltend schönes Ergebnis",
        "Professionelle Rundum-Betreuung",
      ],
      faq: [
        { question: "Spare ich bei der Kombi-Behandlung?", answer: "Ja, die Kombination ist günstiger als beide Behandlungen einzeln zu buchen." },
        { question: "Wie lange dauert die Behandlung?", answer: "Die kombinierte Behandlung dauert etwa 30-45 Minuten." },
        { question: "Wie oft sollte ich die Behandlung wiederholen?", answer: "Für perfekte Brauen empfehlen wir alle 3-4 Wochen eine Behandlung." },
      ],
    },
    "henna-brow": {
      title: "Henna Brow",
      subtitle: "Natürliche Brauenfärbung mit Henna",
      description: "Erleben Sie die natürliche Alternative zur klassischen Brauenfärbung. Henna Brow färbt nicht nur die Härchen, sondern auch die Haut darunter – für einen vollen, definierten Brow-Look, der einem Augenbrauen-Make-up ähnelt. Das pflanzliche Henna ist besonders hautschonend und verleiht Ihren Brauen bis zu 6 Wochen lang intensive Farbe.",
      process: [
        "Ausführliche Beratung zu Farbton und Form",
        "Vorbereitung und Reinigung der Augenbrauen",
        "Optional: Vorheriges Formen der Brauen",
        "Präzises Auftragen des Henna-Farbstoffs",
        "Längere Einwirkzeit für intensive Farbentwicklung",
        "Vorsichtige Entfernung des Hennas",
        "Pflegende Abschlussbehandlung",
      ],
      benefits: [
        "100% natürliche, pflanzliche Färbung",
        "Färbt Härchen und Haut für volleren Look",
        "Langanhaltend bis zu 6 Wochen auf den Härchen",
        "Hautschonend und für Allergiker geeignet",
        "Definierter Brow-Look ohne tägliches Make-up",
        "Verschiedene natürliche Farbtöne möglich",
        "Stärkt und pflegt die Brauenhärchen",
      ],
      faq: [
        { question: "Wie lange hält Henna Brow?", answer: "Auf den Härchen hält die Färbung bis zu 6 Wochen, auf der Haut 1-2 Wochen – je nach Hauttyp und Pflege." },
        { question: "Was ist der Unterschied zur normalen Brauenfärbung?", answer: "Henna färbt auch die Haut unter den Brauen, wodurch ein vollerer, definierter Look entsteht – ähnlich wie mit Augenbrauen-Make-up." },
        { question: "Ist Henna für empfindliche Haut geeignet?", answer: "Ja, Henna ist eine natürliche, pflanzliche Färbung und daher besonders hautschonend." },
        { question: "Welche Farben gibt es?", answer: "Wir bieten verschiedene natürliche Braun- und Rottöne, die individuell gemischt werden können." },
      ],
    },
  "waxing": {
    title: "Waxing",
  ...
  "sugaring": {
    ...
    "kopf-schulter-nackenmassage": {
      title: "Kopf-, Schulter-, Nackenmassage",
      subtitle: "Gezielte Entspannung für Kopf, Schultern und Nacken",
      description: "Lösen Sie Verspannungen genau dort, wo sie am häufigsten entstehen. Die Kopf-, Schulter- und Nackenmassage konzentriert sich auf die Bereiche, die durch Stress, Bildschirmarbeit und Alltagsbelastungen besonders beansprucht werden. Mit gezielten Grifftechniken lösen wir tief sitzende Verspannungen, fördern die Durchblutung und schenken Ihnen spürbare Erleichterung.",
      process: [
        "Kurze Beratung zu Problemzonen und Verspannungen",
        "Bequeme Lagerung auf der Massageliege",
        "Auftragen von warmem Massageöl",
        "Gezielte Massage des Nacken- und Schulterbereichs",
        "Sanfte Kopfmassage zur Entspannung",
        "Lockerung von Triggerpunkten und Verhärtungen",
        "Entspannende Ausklangphase",
      ],
      benefits: [
        "Gezielte Lösung von Verspannungen in Kopf, Schultern und Nacken",
        "Linderung von Spannungskopfschmerzen",
        "Verbesserung der Durchblutung im Kopf- und Nackenbereich",
        "Reduktion von Stress und innerer Anspannung",
        "Erhöhte Beweglichkeit des Schulter-Nacken-Bereichs",
        "Förderung der Konzentration und Klarheit",
        "Sofortige spürbare Erleichterung",
      ],
      faq: [
        { question: "Für wen ist diese Massage besonders geeignet?", answer: "Ideal für alle, die viel am Schreibtisch arbeiten, unter Spannungskopfschmerzen leiden oder Verspannungen im Schulter-Nacken-Bereich haben." },
        { question: "Wie lange dauert die Massage?", answer: "Die Behandlung dauert etwa 30-45 Minuten und konzentriert sich intensiv auf die betroffenen Bereiche." },
        { question: "Wie oft sollte ich zur Massage kommen?", answer: "Bei regelmäßigen Verspannungen empfehlen wir alle 2-4 Wochen eine Behandlung zur nachhaltigen Entspannung." },
        { question: "Kann die Massage bei Kopfschmerzen helfen?", answer: "Ja, viele Spannungskopfschmerzen entstehen durch Verspannungen im Nacken- und Schulterbereich. Die gezielte Massage kann deutliche Linderung bringen." },
      ],
    },
    "klassische-massage": {
    ...
    "ganzkörpermassage": {
      ...
      subtitle: "Vollkommene Entspannung von Kopf bis Fuß",
      description: "Erleben Sie tiefe Entspannung für Ihren gesamten Körper. Die Ganzkörpermassage behandelt alle wichtigen Muskelgruppen von den Schultern über den Rücken bis zu den Beinen. Mit fließenden, harmonischen Bewegungen und gezielten Grifftechniken lösen wir Verspannungen im gesamten Körper, fördern die Durchblutung und schenken Ihnen ein ganzheitliches Wohlbefinden.",
      process: [
        "Ausführliches Gespräch zu Ihren Bedürfnissen",
        "Bequeme Lagerung auf der Massageliege",
        "Auftragen von warmem, wohlriechendem Massageöl",
        "Massage von Rücken, Schultern und Nacken",
        "Behandlung von Armen und Händen",
        "Massage von Beinen und Füßen",
        "Lockerung aller Muskelverspannungen",
        "Entspannende Ausklangphase zum Nachspüren",
      ],
      benefits: [
        "Ganzheitliche Entspannung des gesamten Körpers",
        "Lösung von Muskelverspannungen in allen Bereichen",
        "Deutlich verbesserte Durchblutung",
        "Tiefgreifender Stressabbau und mentale Erholung",
        "Förderung von Regeneration und Wohlbefinden",
        "Stärkung des Immunsystems",
        "Verbesserung der Schlafqualität",
        "Harmonisierung von Körper und Geist",
      ],
      faq: [
        { question: "Wie lange dauert eine Ganzkörpermassage?", answer: "Die Ganzkörpermassage dauert in der Regel 60-90 Minuten, damit alle Bereiche ausreichend behandelt werden können." },
        { question: "Für wen ist die Ganzkörpermassage geeignet?", answer: "Die Ganzkörpermassage ist ideal für alle, die sich eine umfassende Entspannung wünschen, unter mehreren Verspannungen leiden oder sich einfach etwas Gutes tun möchten." },
        { question: "Wie oft sollte ich eine Ganzkörpermassage machen?", answer: "Für langfristige Entspannung und Gesundheitsförderung empfehlen wir alle 4-6 Wochen eine Ganzkörpermassage." },
        { question: "Was ist der Unterschied zur klassischen Massage?", answer: "Die Ganzkörpermassage behandelt den gesamten Körper umfassend, während die klassische Massage sich auf bestimmte Problemzonen konzentriert." },
      ],
    },
  "aromaoelmassage": {
  ...
  "byonik-lift-fresh-up": {
    ...
    "byonik-gesicht-hals-dekollete": {
      title: "BYONIK® Lift PTL Facial - SUPERIOR | Gesicht, Hals und Dekolleté",
      subtitle: "Ganzheitliche Premium-Behandlung",
      description: "Erleben Sie die umfassendste BYONIK® Behandlung für ein harmonisches Gesamtbild. Diese SUPERIOR-Behandlung vereint Gesicht, Hals und Dekolleté in einer luxuriösen Session. Die pulsgesteuerte Lasertechnologie revitalisiert alle Zonen gleichmäßig – für ein ebenmäßiges, jugendliches Erscheinungsbild ohne sichtbare Übergänge.",
    process: [
  ...
  "anti-aging-behandlung": {
    ...
    "byonik-anti-aging-hals": {
      title: "BYONIK® Lift PTL Facial - DELUXE | Gesicht und Halskontur",
      subtitle: "Umfassende Laserbehandlung für Gesicht und Hals",
      description: "Erweitern Sie die Wirkung der BYONIK® Behandlung auf die empfindliche Halspartie. Diese DELUXE-Behandlung kombiniert die pulsgesteuerte Lasertechnologie mit speziellen Wirkstoffen, um Falten und Erschlaffung im Gesicht und am Hals gleichzeitig zu behandeln – für ein harmonisches, verjüngtes Erscheinungsbild.",
    process: [
  ...
  "byonik-show-your-legs": {
    ...
    "aqua-facial": {
      title: "Aqua Facial",
      subtitle: "Moderne Tiefenreinigung zur Porenklärung, intensiven Hydration und sichtbaren Hautverfeinerung",
      description: "Erleben Sie die innovative Aqua Facial Behandlung – eine revolutionäre Methode zur Tiefenreinigung und intensiven Hydration Ihrer Haut. Durch den Einsatz modernster Hydro-Technologie werden abgestorbene Hautzellen sanft entfernt, die Poren tiefenwirksam gereinigt und die Haut gleichzeitig mit wertvollen Wirkstoffen versorgt. Das Ergebnis: ein strahlender, verfeinerte Teint mit sichtbar geklärten Poren und erfrischter Ausstrahlung.",
      process: [
        "Gründliche Reinigung und Vorbereitung der Haut",
        "Sanftes Peeling mit Hydro-Dermabrasion",
        "Tiefenreinigung und Porenextraktion",
        "Intensive Hydratation mit Hyaluron-Infusion",
        "Beruhigende Maske zur Regeneration",
        "Abschlusspflege mit feuchtigkeitsspendenden Wirkstoffen",
      ],
      benefits: [
        "Tiefenreinigung und Porenklärung",
        "Intensive Feuchtigkeitsversorgung",
        "Sichtbar verfeinerte Hautstruktur",
        "Strahlender, frischer Teint",
        "Reduzierung von Unreinheiten und Mitessern",
        "Glattere, geschmeidigere Haut",
        "Verbesserung der Wirkstoffaufnahme",
        "Schmerzfrei und entspannend",
      ],
      faq: [
        { question: "Für welchen Hauttyp ist Aqua Facial geeignet?", answer: "Aqua Facial ist für alle Hauttypen geeignet – besonders empfehlenswert für unreine, dehydrierte oder fahle Haut sowie bei vergrößerten Poren." },
        { question: "Ist die Behandlung schmerzhaft?", answer: "Nein, die Behandlung ist völlig schmerzfrei und sehr angenehm. Viele Kunden empfinden sie als entspannend." },
        { question: "Wie schnell sehe ich Ergebnisse?", answer: "Die Ergebnisse sind sofort nach der ersten Behandlung sichtbar – Ihre Haut erscheint frischer, strahlender und verfeinert." },
    ...
    "luxus-behandlung": {
      title: "Luxus-Behandlung",
      subtitle: "Premium-Verwöhnprogramm für anspruchsvolle Haut",
      description: "Gönnen Sie sich das Beste für Ihre Haut. Die Luxus-Behandlung vereint exklusive Wirkstoffe, modernste Techniken und entspannende Massagen zu einem einzigartigen Verwöhn-Erlebnis. Hochkonzentrierte Seren, edle Masken und luxuriöse Pflegeprodukte verwandeln Ihre Haut in ein strahlendes Meisterwerk. Perfekt für besondere Anlässe oder wenn Sie sich einfach etwas Besonderes gönnen möchten.",
      process: [
        "Ausführliche Hautanalyse und Beratung",
        "Luxuriöse Tiefenreinigung mit edlen Produkten",
        "Premium-Peeling für samtige Haut",
        "Entspannende Gesichtsmassage",
        "Hochwirksame Seren und Ampullen",
        "Exklusive Luxus-Maske",
        "Abschlusspflege mit Premium-Produkten",
      ],
      benefits: [
        "Intensive Hautverjüngung und Regeneration",
        "Sofort sichtbare Strahlkraft",
        "Tiefe Entspannung und Wellness-Erlebnis",
        "Verbesserung von Elastizität und Festigkeit",
        "Reduktion von Falten und Linien",
        "Luxuriöse Verwöhnung für Haut und Sinne",
        "Langanhaltender Glow-Effekt",
      ],
      faq: [
        { question: "Was macht die Luxus-Behandlung so besonders?", answer: "Die Luxus-Behandlung kombiniert die besten Wirkstoffe, modernste Techniken und entspannende Elemente für maximale Ergebnisse und pures Wohlgefühl." },
        { question: "Für welchen Hauttyp ist die Behandlung geeignet?", answer: "Die Luxus-Behandlung ist für alle Hauttypen geeignet und wird individuell auf Ihre Bedürfnisse angepasst." },
        { question: "Wie oft sollte ich die Behandlung durchführen?", answer: "Als besondere Verwöhnung empfehlen wir die Luxus-Behandlung alle 6-8 Wochen oder vor besonderen Anlässen." },
      ],
    },
    "akne-behandlung": {
      title: "Akne manuelle Reinigung und Seboregulation",
      subtitle: "Gezielte Behandlung für unreine und zu Akne neigende Haut",
      description: "Diese spezialisierte Behandlung kombiniert professionelle manuelle Ausreinigung mit gezielter Seboregulation für nachhaltig reine Haut. Durch präzise Porenreinigung, antibakterielle Wirkstoffe und talgregulierte Pflege bekämpfen wir Unreinheiten an der Wurzel. Ideal für zu Akne neigende Haut, Mitesser und verstopfte Poren.",
      process: [
        "Gründliche Hautanalyse",
        "Tiefenreinigung mit antibakteriellen Produkten",
        "Sanftes Peeling zur Vorbereitung",
        "Professionelle manuelle Ausreinigung",
        "Beruhigende und desinfizierende Behandlung",
        "Talgregulatorische Maske",
        "Abschlusspflege zur Seboregulation",
      ],
      benefits: [
        "Tiefenreinigung verstopfter Poren",
        "Reduktion von Pickeln und Mitessern",
        "Regulation der Talgproduktion",
        "Antibakterielle und entzündungshemmende Wirkung",
        "Verfeinertes Hautbild",
        "Vorbeugung neuer Unreinheiten",
        "Klarer, ebenmäßiger Teint",
      ],
      faq: [
        { question: "Ist die Behandlung schmerzhaft?", answer: "Die manuelle Ausreinigung kann leicht unangenehm sein, ist aber in der Regel gut erträglich. Wir arbeiten so sanft wie möglich." },
        { question: "Wie oft sollte ich die Behandlung wiederholen?", answer: "Bei akuter Akne empfehlen wir zunächst alle 2-3 Wochen eine Behandlung, später als Erhaltung alle 4-6 Wochen." },
        { question: "Kann meine Haut danach gerötet sein?", answer: "Ja, leichte Rötungen nach der Ausreinigung sind normal und klingen innerhalb weniger Stunden ab." },
        { question: "Welche Heimpflege empfehlen Sie?", answer: "Wir beraten Sie individuell zu Produkten mit talgregulierenden, antibakteriellen Wirkstoffen für die optimale Heimpflege." },
      ],
    },
    "trockene-haut-behandlung": {
      title: "Behandlung für trockene Haut",
      subtitle: "Intensive Feuchtigkeitspflege für spürbar geschmeidige Haut",
      description: "Schenken Sie Ihrer trockenen Haut die intensive Feuchtigkeit und Pflege, die sie verdient. Diese Behandlung versorgt Ihre Haut tiefenwirksam mit Feuchtigkeit, stärkt die Hautbarriere und lindert Spannungsgefühle. Mit hochwirksamen Hyaluron-Komplexen, nährenden Ölen und reichhaltigen Masken wird Ihre Haut wieder samtig-weich und geschmeidig.",
      process: [
        "Sanfte Reinigung mit feuchtigkeitsspendenden Produkten",
        "Hautanalyse zur Bestimmung des Feuchtigkeitsdefizits",
        "Sanftes enzymatisches Peeling",
        "Auftragen von hochkonzentrierten Feuchtigkeitsseren",
        "Nährende Gesichtsmassage mit reichhaltigen Ölen",
        "Intensive Feuchtigkeitsmaske",
        "Abschlusspflege mit reichhaltiger Creme",
      ],
      benefits: [
        "Intensive und langanhaltende Feuchtigkeitsversorgung",
        "Linderung von Spannungsgefühlen",
        "Geschmeidige, samtig-weiche Haut",
        "Stärkung der Hautbarriere",
        "Reduktion von Trockenheitsfältchen",
        "Beruhigung und Komfort",
        "Gesunder, strahlender Teint",
      ],
      faq: [
        { question: "Woran erkenne ich, dass ich trockene Haut habe?", answer: "Trockene Haut fühlt sich oft gespannt an, schuppt leicht und zeigt feine Trockenheitsfältchen. Sie reagiert empfindlich auf Kälte und Wind." },
        { question: "Wie oft sollte ich die Behandlung wiederholen?", answer: "Bei sehr trockener Haut empfehlen wir zunächst alle 2-3 Wochen eine Behandlung, danach alle 4-6 Wochen zur Erhaltung." },
        { question: "Welche Heimpflege empfehlen Sie?", answer: "Wir beraten Sie gerne zu einer passenden Pflegeroutine mit reichhaltigen Cremes, Ölen und Hyaluron-Seren für zu Hause." },
      ],
    },
