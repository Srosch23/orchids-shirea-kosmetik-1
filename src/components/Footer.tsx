        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-8">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-background/80">
              ...
              <a href="/Datenschutzerklaerung_Shirea.pdf" target="_blank" rel="noopener noreferrer" className="block hover:text-background transition-colors">
                Datenschutzerklärung
              </a>
              <a href="/AGB_Shirea_Kosmetikstudio.pdf" target="_blank" rel="noopener noreferrer" className="block hover:text-background transition-colors">
                AGB
              </a>
            </div>
          </div>
